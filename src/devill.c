...
int main(int argc, char *argv[]) {
    ...
    if (argc == 2 && strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "--help") == 0) {
		...
		printf("Devill(v23.7.23) starting\n\n");
        hashidtfy(argv[2]);
    }
	...
	else if (argc == 8 && strcmp(argv[1],"--format=") == 0  && strcmp(argv[3],"--wordlist=") == 0 && strcmp(argv[6], "--crack") == 0 && strcmp(argv[7], "-V") == 0) {
